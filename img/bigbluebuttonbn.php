...
$string['activityoverview'] = 'You have upcoming Octa sessions';
...
$string['bigbluebuttonbn:addinstance'] = 'Add a new Octa room/activity';
$string['bigbluebuttonbn:join'] = 'Join a Octa meeting';
$string['bigbluebuttonbn:view'] = 'View a room/activity';
$string['bigbluebuttonbn:managerecordings'] = 'Manage Octa recordings';
...
$string['bigbluebuttonbn'] = 'Octa';
$string['indicator:cognitivedepth'] = 'Octa cognitive';
$string['indicator:cognitivedepth_help'] = 'This indicator is based on the cognitive depth reached by the student in a Octa activity.';
$string['indicator:socialbreadth'] = 'Octa social';
$string['indicator:socialbreadth_help'] = 'This indicator is based on the social breadth reached by the student in a Octa activity.';
$string['modulename'] = 'Octa';
$string['modulenameplural'] = 'Octa';
$string['modulename_help'] = 'Octa lets you create from within Moodle links to real-time on-line classrooms using Octa, a web conferencing system for distance education.

Using Octa you can specify for the title, description, calendar entry (which gives a date range for joining the session), groups, and details about the recording of the on-line session.';
$string['modulename_link'] = 'Octa/view';
$string['pluginadministration'] = 'Octa administration';
$string['pluginname'] = 'Octa';
...
$string['search:activity'] = 'Octa - activity information';
$string['search:tags'] = 'Octa - tags information';

$string['privacy:metadata:bigbluebuttonbn'] = 'Stores the configuration for the room or activity that defines the features and general behaviour of the Octa session.';
...
$string['privacy:metadata:bigbluebutton'] = 'In order to create and join Octa sessions, user data needs to be exchanged with the server.';
$string['privacy:metadata:bigbluebutton:userid'] = 'The userid of the user accessing the Octa server.';
$string['privacy:metadata:bigbluebutton:fullname'] = 'The fullname of the user accessing the Octa server.';

$string['config_general'] = 'General configuration';
$string['config_general_description'] = 'These settings are <b>always</b> used';
$string['config_server_url'] = 'Octa Server URL';
$string['config_server_url_description'] = 'The URL of your Octa server must end with /Octa/. (This default URL is for a octa server provided by Blindside Networks that you can use for testing.)';
$string['config_shared_secret'] = 'Octa Shared Secret';
$string['config_shared_secret_description'] = 'The security salt of your Octa server.  (This default salt is for a Octa server provided by Blindside Networks that you can use for testing.)';
...
$string['config_recording_default_description'] = 'If enabled the sessions created in Octa will have recording capabilities.';
...
$string['config_waitformoderator_cache_ttl_description'] = 'To support a heavy load of clients this plugin makes use of a cache. This parameter defines the time the cache will be kept before the next request is sent to the Octa server.';
...
$string['config_preuploadpresentation_description'] = 'These settings enable or disable options in the UI and also define default values for these options. The feature works only if the Moodle server is accessible to Octa..';
...
$string['config_presentation_default_description'] = 'This setting allow to select a file to use as default in all Octa instances if "Pre-upload presentation" is enabled.';
...
$string['config_extended_capabilities_description'] = 'Configuration for extended capabilities when the Octa server offers them.';
$string['config_uidelegation_enabled'] = 'UI delegation is enabled';
$string['config_uidelegation_enabled_description'] = 'These settings enable or disable the UI delegation to the Octa server.';
...
$string['config_warning_bigbluebuttonbn_cfg_deprecated'] = 'Octa is making use of config.php with a global variable that has been deprecated. Please convert the file as it will not be supported in future versions';
...
$string['general_error_unable_connect'] = 'Unable to connect. Please check the url of the Octa server AND check to see if the Octa server is running.';
...
$string['index_error_unable_display'] = 'Unable to display the meetings. Please check the url of the Octa server AND check to see if the Octa server is running.';
...
$string['index_heading'] = 'Octa Rooms';
...
$string['mod_form_field_welcome_help'] = 'Replaces the default message setted up for the Octa server. The message can includes keywords  (%%CONFNAME%%, %%DIALNUM%%, %%CONFNUM%%) which will be substituted automatically, and also html tags like <b>...</b> or <i></i> ';
$string['mod_form_field_welcome_default'] = '<br>Welcome to <b>%%CONFNAME%%</b>!<br><br> <a href="event:http://radiusedutech.com/#contact"></a>.<br><br> <b>To join the audio bridge click the phone button. Use a headset to avoid causing background noise for others.</b>';
...
$string['mod_form_field_instanceprofiles_help'] = 'Select the type for this Octa instance.';
...
$string['view_error_unable_join_student'] = 'Unable to connect to the Octa server. Please contact your Teacher or the Administrator.';
$string['view_error_unable_join_teacher'] = 'Unable to connect to the Octa server. Please contact the Administrator.';
$string['view_error_unable_join'] = 'Unable to join the meeting. Please check the url of the Octa server AND check to see if the Octa server is running.';
$string['view_error_bigbluebutton'] = 'Octa responded with errors. {$a}';
$string['view_error_create'] = 'The Octa server responded with an error message, the meeting could not be created.';
...
$string['view_noguests'] = 'The Octa is not open to guests';
...
$string['view_message_recordings_disabled'] = 'Recordings were disabled on this server. Octa instances for recordings only can not be used.';
...
$string['view_recording_publish_link_deleted'] = 'This link can not be re-published because the actual recording does not exist in the current Octa server. The link should be removed.';
...
$string['view_recording_unprotect_link_deleted'] = 'This link can not be un-protected because the actual recording does not exist in the current Octa server. The link should be removed.';
...
$string['view_error_current_state_not_found'] = 'Current state was not found. The recording may have been deleted or the Octa server is not compatible with the action performed.';
$string['view_error_action_not_completed'] = 'Action could not be completed';
$string['view_warning_default_server'] = 'This Moodle server is making use of the Octa testing server that comes pre-configured by default. It should be replaced for production.';
...
$string['index_error_noinstances'] = 'There are no instances of Octa';
$string['index_error_bbtn'] = 'Octa ID {$a} is incorrect';
